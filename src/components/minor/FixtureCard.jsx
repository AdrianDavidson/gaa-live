    ...
    >
      ...
      <div className="flex-1 p-3">
        ...
        <div className="flex items-center justify-between gap-2">
          <span className="font-bold text-sm text-gray-900 truncate">{game.home_team}</span>
          <span className="text-[10px] text-gray-400 font-bold shrink-0">vs</span>
          <span className="font-bold text-sm text-gray-900 truncate text-right">{game.away_team}</span>
        </div>
